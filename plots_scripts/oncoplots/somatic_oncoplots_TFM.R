...
# Make oncoplot 
cat("\n-----Making oncoplot with SNVs...\n") 

# --Tumor grouped
# Open device 
pdf(file.path(output_dir, "somatic_oncoplot_tumor.pdf"), width = 22, height = 14)
...
cat("\n-----Oncoplot with SNVs saved in ", output_dir, "\n")

# --Unique case grouped
# Open device 
pdf(file.path(output_dir, "somatic_oncoplot_unique.pdf"), width = 22, height = 14)
...
# Make oncoplot 
cat("\n-----Making oncoplot with SNVs (VAF > 80)...\n") 

# --Tumor grouped
# Open device 
pdf(file.path(output_dir_VAF80, "somatic_oncoplot_VAF80_tumor.pdf"), width = 22, height = 14)
...
cat("\n-----Oncoplot with SNVs (VAF > 80) saved in ", output_dir_VAF80, "\n")


# --Unique case grouped
# Open device 
pdf(file.path(output_dir_VAF80, "somatic_oncoplot_VAF80_unique.pdf"), width = 22, height = 14)
...
# Make oncoplot 
cat("\n-----Making oncoplot with SNVs (dd-score)...\n") 

# --Tumor grouped
# Open device 
pdf(file.path(output_dir_filtered, "somatic_oncoplot_filtered_tumor.pdf"), width = 22, height = 14)
...
cat("\n-----Oncoplot with SNVs (dd-score) saved in ", output_dir_filtered, "\n")


# --Unique case grouped
# Open device 
pdf(file.path(output_dir_filtered, "somatic_oncoplot_filtered_unique.pdf"), width = 22, height = 14)
...
write.table(
  snvs_with_CNVs@data,
  file = "/storage/scratch01/groups/bu/impact_vuscan/cohort_characterization/oncoplots/snvs_with_cnvs.maf",
  sep = "\t",
  row.names = FALSE,
  quote = FALSE
)
...
# Make oncoplot 
cat("\n-----Making oncoplot with SNVs + CNVs...\n") 

# --Tumor grouped
# Open device 
pdf(file.path(output_dir, "somatic_oncoplot_CNVs_SNVs_tumor.pdf"), width = 22, height = 14)
...
cat("\n-----Oncoplot with SNVs + CNVs saved in ", output_dir, "\n")


# --Unique case grouped
# Open device 
pdf(file.path(output_dir, "somatic_oncoplot_CNVs_SNVs_unique.pdf"), width = 22, height = 14)
...
write.table(
  snvs_80_with_CNVs@data,
  file = "/storage/scratch01/groups/bu/impact_vuscan/cohort_characterization/oncoplots/snvs_80_with_cnvs.maf",
  sep = "\t",
  row.names = FALSE,
  quote = FALSE
)
...
# Make oncoplot 
cat("\n-----Making oncoplot with SNVs (VAF > 80) + CNVs...\n") 

# --Tumor grouped
# Open device 
pdf(file.path(output_dir_VAF80, "somatic_oncoplot_CNVs_SNVs_VAF80_tumor.pdf"), width = 22, height = 14)
...
cat("\n-----Oncoplot with SNVs + CNVs (VAF > 80) saved in ", output_dir_VAF80, "\n")


# --Unique case grouped
# Open device 
pdf(file.path(output_dir_VAF80, "somatic_oncoplot_CNVs_SNVs_VAF80_unique.pdf"), width = 22, height = 14)
...
# --Tumor grouped
pdf(file.path(output_dir, "somatic_oncoplot_CNVs_tumor.pdf"), width = 22, height = 14)
par(
    mar = c(6, 10, 12, 6),
    oma = c(4, 0, 2, 0),
    cex = 1,
...
# --Unique case grouped
pdf(file.path(output_dir, "somatic_oncoplot_CNVs_unique.pdf"), width = 22, height = 14)
par(
    mar = c(6, 10, 12, 6),
    oma = c(4, 0, 2, 0),
    cex = 1,
